...
public class OTPApi {
    ...
    public static void sendOtpToMobileVerification(Context context, String value,VolleyResponse volleyResponse){
        HashMap<String, Object> params = new HashMap<String, Object>();
        ConnectionVO connectionVO = SignUpBO.sendOTPforMobileVerificationOnProfile();
