...
public class Session {
    ...
    public final static String CACHE_IS_LOGIN_TIME = "LOGINTRUE";
    ...
    // New
    public static boolean check_Exists_Timer_key(Context context, String key) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(ApplicationConstant.SHAREDPREFENCE, Context.MODE_PRIVATE);
        return sharedPreferences.contains(key);
    }
    ...
    public static String getCustomerIdOnExceptionTime(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(ApplicationConstant.SHAREDPREFENCE, Context.MODE_PRIVATE);
        CustomerVO customerVO = gson.fromJson(sharedPreferences.getString(Session.CACHE_CUSTOMER, null), CustomerVO.class);
        return customerVO != null && customerVO.getCustomerId() != null ? customerVO.getCustomerId().toString() : null;
    }


    public static String getCustomerMobileNumber(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(ApplicationConstant.SHAREDPREFENCE, Context.MODE_PRIVATE);
        CustomerVO customerVO = gson.fromJson(sharedPreferences.getString(Session.CACHE_CUSTOMER, null), CustomerVO.class);
        return customerVO.getMobileNumber();
    }
